...
import { socialIconMap } from "@/lib/icon-maps";
...
export default function Footer({ contact, socialLinks }: Props) {
        ...
        <Section href="contact" className="relative flex flex-col items-center">
          ...
          >
            ...
            <Button asChild variant="default" className="group relative flex items-center gap-3">
              <Link href={contact.cal_link} target="_blank" rel="noopener noreferrer">
                <Calendar
            ...
            <Button asChild variant="default" className="group relative flex items-center gap-3">
              <Link href={`mailto:${contact.email}?subject=${encodeURIComponent("Work Inquiry")}`}>
