      ...
      <div className="flex-1 grid grid-cols-1 md:grid-cols-12 relative z-10 h-full">
        <div className="md:col-span-8 flex flex-col overflow-hidden">
          <div className="p-6 md:p-8 flex justify-between items-center">
            ...
            >
              <span className="text-[10px] uppercase tracking-[0.2em] text-secondary/60">From Kottayam, Kerala</span>
          ...
          <div className="mt-auto grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="flex bg-secondary/5 divide-x-2 divide-border/40">
              {stats?.map((stat, index) => (
                <div key={index} className="flex-1 p-6 md:p-8 flex flex-col items-center justify-center text-center group cursor-pointer transition-colors duration-300">
                  <span className="text-[10px] uppercase tracking-[0.2em] text-primary transition-colors duration-300">{stat.label}</span>
                  <span className="text-2xl md:text-3xl font-black uppercase tracking-tighter text-primary transition-colors duration-300">{stat.value}</span>
                </div>
              ))}
            </div>
          </div>
