        ...
        <div className="relative text-center">
          <div>
            <BlurText
              ...
              animateBy="letters"
              direction="top"
              className="font-bold text-primary text-[80px] sm:text-[140px] md:text-[180px] lg:text-[210px] leading-[0.75] tracking-tighter uppercase justify-center"
          ...
          <div>
            <BlurText
              ...
              animateBy="letters"
              direction="top"
              className="font-bold text-primary mt-5 text-[80px] sm:text-[140px] md:text-[180px] lg:text-[210px] leading-[0.75] tracking-tighter uppercase justify-center"
              style={{ fontFamily: "'Fira Code', monospace" }}
            />
          </div>
