...
import { ProjectsModal } from "@/app/(home)/_components/ProjectsModal"
...
export function Projects() {
  ...
  return (
    <>
              ...
              {SITE_CONTENT.projects.map((project, index) => {
                ...
                return (
                  <Image
                    ...
                    style={{
                      opacity: hoveredIndex === index ? (isFallback ? 0.25 : 1) : 0,
                  ...
                  <div className="relative flex items-start justify-between gap-4">
                      ...
                      <div className="relative overflow-hidden h-[60px] md:h-20 group">
                        ...
                        >
                          <div className="h-[60px] md:h-20 flex items-center">
                            <h2 className="text-muted-foreground text-3xl md:text-5xl">{project.name}</h2>
                          </div>
                          <div className=" flex items-center gap-2">
                            <h2 className="text-3xl md:text-5xl font-black italic text-primary">{project.name}</h2>
                            <ArrowUpRight
                              className={cn(
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      >
                        ...
                        />
                        <span className="text-xs transition-all duration-300 ease-out">GitHub</span>
                      </Button>
                    </div>
                  </div>
                </div>
      ...
      <ProjectsModal project={selectedProject} isOpen={isModalOpen} onClose={handleCloseModal} />
    </>
  )
}
