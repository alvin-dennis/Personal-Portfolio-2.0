...
export default function Projects() {
  return (
    <div className="col-span-12 lg:col-span-5 bg-[#161616]/40 rounded-[2rem] p-6 relative h-full md:min-h-0 min-h-[50vh] overflow-y-auto scrollbar-hide border border-white/10 hover:border-white/20 transition-colors backdrop-blur-md shadow-lg">
