      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="md:w-3/4">
          <p className="text-xl mb-4">
            Hi, My name is <span className="font-bold">ALVIN DENNIS</span>. a
            ...
            UI/UX design, web development, software testing, and discord bot development, adaptable and
            disciplined, with strong teamwork abilities and event management
            experience, committed to delivering innovative and impactful
            solutions.
          </p>
